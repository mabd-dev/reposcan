...
- feat/staleDays: add `--stale-days` / `staleDays` to show only repos with no local activity for N days by @mabd-dev in [#79](https://github.com/mabd-dev/reposcan/pull/79)
